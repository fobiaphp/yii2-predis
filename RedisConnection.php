<?php
/**
 * RedisConnection.php file
 * @author     Dmitriy Tyurin <fobia3d@gmail.com>
 * @copyright  Copyright (c) 2016 Dmitriy Tyurin
 */

namespace fobia\yii\predis;
...
class Connection extends Component
{
    ...
    public function getConnection()
    {
        if ($this->_client === null) {
            ...
            $this->_client = new Client($parameters, (array) $this->options);
        }
        return $this->_client;
    }
    ...
    public function executeCommand($name, $params = [])
    {
        ...
        switch (count($params)) {
            case 0: return $redis->$name();
            case 1: return $redis->$name($params[0]);
            case 2: return $redis->$name($params[0], $params[1]);
            case 3: return $redis->$name($params[0], $params[1], $params[2]);
            case 4: return $redis->$name($params[0], $params[1], $params[2], $params[3]);
            case 5: return $redis->$name($params[0], $params[1], $params[2], $params[3], $params[4]);
            default: return call_user_func_array([$redis, $name], $params);
        }
    }
